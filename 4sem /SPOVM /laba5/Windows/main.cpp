...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	HINSTANCE hDll;
	if (!(hDll = LoadLibrary(TEXT("D:\\4sem\\СПОВМ\\Dll\\Debug\\Dll.dll"))))
	{
	...
	EventCreate = (lpfnDllCreateEvent)GetProcAddress(hDll, TEXT("EventCreate")); //находим функцию в динамической библиотеке
	...
	TCHAR lpCurrentDirectory[MAX_PATH]; //путь к текущей директории
